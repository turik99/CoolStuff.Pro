...
//instantiating AWS S3 object with our credientials.
const s3 = new S3({
  region: awsRegion,
  accessKeyId: awsKey,
...
//Declaring MongoDB connection string to create
...
//Route to gather products in a category from DB and send them in order to the user.
...
//Get the rank ordered list of objects in a product category from users.
...
//Setting the app to listen and serving optimized build files when in production
app.listen(PORT, () => {
